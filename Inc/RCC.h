...
// For SPI
#define ENABLLE_SPI1_CLK_GATING()     rcc->apb2enr |= (1 << 12)
#define ENABLLE_SPI2_CLK_GATING()     rcc->apb1enr |= (1 << 14)
#define ENABLLE_SPI3_CLK_GATING()     rcc->apb1enr |= (1 << 15)
...
// For SPI
#define UNRESET_SPI1_CLK_GATING()			  rcc->apb2rstr &= ~(1 << 12)
#define UNRESET_SPI2_CLK_GATING()			  rcc->apb1rstr &= ~(1 << 14)
#define UNRESET_SPI3_CLK_GATING()			  rcc->apb1rstr &= ~(1 << 15)
// For ADC
...
// For SPI
#define RESET_SPI1_CLK_GATING()			    rcc->apb2rstr |= (1 << 12)
#define RESET_SPI2_CLK_GATING()			    rcc->apb1rstr |= (1 << 14)
#define RESET_SPI3_CLK_GATING()			    rcc->apb1rstr |= (1 << 15)
// For ADC
