...
#define SPI_BAUD_CON_2            (0 << 3)  // peripheral clk freq divide by 2
...
#define SPI_PERIPHERAL_EN         (1 << 6)  // Enable peripheral
...
#define spiClearAllFlag(spi)            spiClearFlag(spi, SPI_RX_BUFFER_XEMPTY |  SPI_TX_BUFFER_EMPTY |\
